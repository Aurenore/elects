...
"""
Inspired by the Transformer model from the breizhcrops project, this is a transformer model without positional encoding.
Source: https://github.com/dl4sits/BreizhCrops/blob/master/breizhcrops/models/TransformerModel.py 
"""
