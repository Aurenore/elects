"""
Inspired from Breizhcrops project, this is a transformer model with positional encoding.
Source: https://github.com/dl4sits/BreizhCrops/blob/master/breizhcrops/models/PETransformerModel.py 
"""
